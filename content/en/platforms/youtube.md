...
![Open Google Cloud](/content/images/01-open-google-cloud.png)

### Step 2: Click Console

Click **Console** in the top-right corner of the page.

![Click Console](/content/images/02-click-console.png)

### Step 3: Open the Dashboard

You will see the Google Cloud Dashboard.

![Dashboard](/content/images/03-dashboard.png)
...
![Open menu](/content/images/09-open-menu.png)

### Step 10: Go to APIs & Services

Navigate to **APIs & Services** → **Library**.

![APIs and Services](/content/images/10-apis-and-services.png)

### Step 11: Go to APIs & Services

Navigate to **APIs & Services** → **Library**.

![APIs and Services](/content/images/11-enable-apis-and-services.png)

### Step 12: Search for YouTube Data API

In the API Library, search for `YouTube Data API v3`.

![Search YouTube API](/content/images/12-search-youtube-api.png)

### Step 13: Select YouTube Data API v3

Click on **YouTube Data API v3** from the search results.

![Select YouTube API](/content/images/13-select-youtube-api.png)

### Step 14: Enable the API

Click the **Enable** button.

![Enable API](/content/images/14-enable-api.png)
...
![OAuth consent screen](/content/images/15-oauth-consent-screen.png)

### Step 16: Get start

Select **Get start button** and Click **Create**.

![Select user type](/content/images/16-get-start.png)

### Step 17: Fill App Information

Enter the required app information: App name, User support email. Click **Next**.

![App information](/content/images/17-app-information.png)

### Step 18: Select user type

Click **External** and click **Next**.

![Configure scopes](/content/images/18-user-type-information.png)

### Step 19: Contact information

Add your email and click **Next**.

![Add test users](/content/images/19-contact-information.png)

### Step 20: Finish

Agree Google user data policy and click **Continue**.

![Add test users](/content/images/20-finish.png)

### Step 21: Create

Click on **Create**.

![Review summary](/content/images/21-create.png)
...
![Go to credentials](/content/images/21-go-to-credentials.png)

### Step 22: Click Create Credentials

Click **Create OAuth client**.

![Create credentials](/content/images/22-create-credentials.png)

### Step 23: Select Application Type

Select **Web application** as the application type.

![Select application type](/content/images/23-select-application-type.png)
...
![Configure redirect URI](/content/images/24-configure-redirect-uri.png)

### Step 25: Copy Client ID and Secret

A dialog will appear with your **Client ID** and **Client Secret**. Copy both values.

![Copy credentials](/content/images/25-copy-credentials.png)
