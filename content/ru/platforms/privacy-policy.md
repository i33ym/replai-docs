...
Добро пожаловать в **Gapex**. Ваша конфиденциальность важна для нас. Настоящая Политика конфиденциальности объясняет, как Gapex («мы», «наш») собирает, использует, хранит и защищает вашу информацию при использовании наших услуг.

Настоящая политика распространяется на наш веб-сайт и платформу, доступные по адресу: `https://gapex.ai/privacy`

Используя Gapex, вы соглашаетесь с практиками, описанными в настоящей Политике конфиденциальности.

## 1. Информация, которую мы собираем

При использовании Gapex мы можем собирать следующие виды информации.
...
Если вы подключаете свои аккаунты социальных сетей к Gapex, мы можем получить доступ и хранить следующие данные в зависимости от предоставленных разрешений:
...
Gapex использует технологии искусственного интеллекта для анализа взаимодействий в социальных сетях и генерации предлагаемых ответов.
...
Gapex хранит пользовательские данные, включая сообщения и комментарии, связанные с вашим аккаунтом.
...
Gapex может использовать сторонние сервисы для работы платформы, включая:
...
Пользователи Gapex имеют право:
...
Gapex предназначен для пользователей, управляющих бизнес- или профессиональными аккаунтами в социальных сетях. Платформа создана для помощи бизнесам в управлении коммуникацией с их аудиторией.

## 9. Подписка

Gapex работает по модели подписки.

Платёжная информация может обрабатываться сторонними платёжными провайдерами. Gapex не хранит полные данные платёжных карт.

## 10. Конфиденциальность детей

Gapex не предназначен для детей. Наши услуги предназначены для владельцев бизнес-аккаунтов.
...
Обновлённые версии будут размещены по адресу: `https://gapex.ai/privacy`
